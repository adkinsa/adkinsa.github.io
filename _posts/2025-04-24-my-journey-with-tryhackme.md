...
Some of my favorite rooms I have completed so far include the **Nmap**, **Networking Concepts**, and **Network Services** rooms. The Nmap room was an introduction to using the Nmap tool, and the Networking Concepts room was an introduction to the OSI model and TCP/IP protocol suite. Both of these rooms were beneficial, as they were related to some of the concepts and objectives for the CompTIA Network+ N10-009 certification, which I am currently studying for. I also enjoyed the Network Services room, which covered the network services SMB, Telnet, and FTP, as well as how to enumerate and exploit them.
